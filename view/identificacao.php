    ...
    <form method="post">
        <fieldset class="formulario__campo">
            ...
            <section>
                ...
                <div class="mv0-5">
                    <input type="text" value="" name="nomeIdentificacao" required id="nomeIdentificacao" class="formulario__entrada">
                </div>
            </section>
            ...
            <section>
                ...
                <div class="mv0-5">
                    ...
                    pattern="^[0-9]{10,11}$" placeholder="51123456789" class="formulario__entrada">
                </div>
            </section>
            <section>
                <label class="formulario__etiqueta" for="emailContatoMercado">E-mail</label>
                <div class="mv0-5">
                    <input type="tel" minlength="3" value="" id="emailContatoMercado" name="emailContatoMercado" placeholder="exemplo@gmail.com" class="formulario__entrada">
                </div>
            </section>
            <section >
                <label class="formulario__etiqueta" for="desc_atividade">Descrição da atividade</label>
                <div class="mv0-5">
                    <textarea class="formulario__caixa__texto" id="desc_atividade" required></textarea>
                </div>
            </section>
        </fieldset>
        <div class="mv0-5">
